        ...
        meterText.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                try{
                    ...
                    ResultSet resultSet = c.statement.executeQuery("select * from `new_customer`  where meter_no = '"+meterText.getText()+"'");
                    if (resultSet.next()){
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()== create){
            ...
            try {
                ...
                if (susername.matches(("(?=.*[a-z0-9]+$).{2,12}$")) && spassword.matches("(?=.*[a-z0-9!@#$]+$).{2,8}$")) {
                    ...
                    JOptionPane.showMessageDialog(null, "Invalid!!Name or Password can not contain special Character");
